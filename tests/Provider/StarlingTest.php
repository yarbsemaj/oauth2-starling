...
use AdamPaterson\OAuth2\Client\Provider\Starling;
use Mockery as m;
use ReflectionClass;

class StarlingTest extends \PHPUnit_Framework_TestCase
{
    protected $provider;

    protected static function getMethod($name)
    {
        $class = new ReflectionClass('AdamPaterson\OAuth2\Client\Provider\Starling');
